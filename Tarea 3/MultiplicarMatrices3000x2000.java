...
public class MultiplicarMatrices3000x2000 {

   static final int N = 3000; // Número de filas de la matriz A
   static final int M = 2000; // Número de columnas de la matriz A y filas de la matriz B
   ...
   private static void executeNode2or3(int nodeNumber) throws Exception {
      ...
      ServerSocket serverSocket = new ServerSocket(PUERTO); // Reemplaza 5000 con el puerto del nodo
